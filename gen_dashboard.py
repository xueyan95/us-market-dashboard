...
<div class="card">
  ...
  <div class="sec-desc">左轴为 Forward P/E，右轴为 ETF 常规盘收盘价。SPY 最新点使用 State Street 官方 FY1 P/E；历史点为 Siblis 的美国大盘月末代理，悬停会标明来源。SOXX 为 iShares 每日持仓按市值加权、结合 BusinessQuant FY1 共识 EPS 的估算值。SOXX 只有估算覆盖率 ≥90% 时才绘制估值点。</div>
